...
export const products = {
  ...
  OmniRoad: {
    ...
    dataCentricAI: {
      ...
      bulletPoints: [
        "Easy Integration with Current Cameras: OmniRoad works with your existing infrastructure, making setup fast and cost-effective",
        "Minimal Configuration Needed: Connect the system, and OmniRoad’s AI automatically begins analyzing traffic data",
        "Cloud or On-Premises Options: Choose cloud-based processing or local deployment based on security and performance needs.",
      ],
      buttonText: "Learn More",
      images: [
        { src: feature1, score: 90, agreement: true },
